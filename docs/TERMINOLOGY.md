...
- [ ] **`relay_mcp_session_id`** = session merge key; tool returns JSON `{relay_mcp_session_id, human}`; pass id on next call; tab label **MM-DD HH:mm** (**RELAY_MCP_SESSION_ID.md**)
