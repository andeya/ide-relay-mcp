...
- **WSL**\uff1a\u82e5\u5728 WSL \u5185\u4f7f\u7528 Windows relay.exe\uff0c\u8bf7\u5728 \`args\` \u4e2d\u52a0 \`"--exe_in_wsl"\`\u3002`,
  ...
  remotePreemptBtn: "抢占",
  remoteReleaseBtn: "释放",
  remoteRoutingLocal: "本地优先",
  remoteRoutingRemote: "远程优先",
  remotePreemptHint: "设为远程优先后，MCP 将优先连接远程 GUI",
  remoteReclaimBtn: "夺回本地",
  remoteReclaimOk: "已清除远程抢占。MCP 将优先连接本地 GUI。",
  remoteLocalPinLabel: "锁定本地 GUI",
  remoteLocalPinHint: "开启后，远程端无法抢占 MCP 路由，始终连接本地 GUI",
  remoteLocalPinOn: "已锁定",
  remoteLocalPinOff: "未锁定",
  remotePreemptPinnedErr: "远程主机已被本地用户锁定，无法抢占。",
  remoteLoadingText: "加载连接中…",
  remoteLoadError: "加载连接失败。",
  remoteRetryBtn: "重试",
  remoteDetailPort: "端口",
  remoteDetailKey: "密钥：",
  remoteDetailJump: "跳板：",
