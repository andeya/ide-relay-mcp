...
- **WSL**: add \`"--exe_in_wsl"\` to \`args\` if running inside WSL with Windows relay.exe.`,
  ...
  remotePreemptBtn: "Preempt",
  remoteReleaseBtn: "Release",
  remoteRoutingLocal: "Local priority",
  remoteRoutingRemote: "Remote priority",
  remotePreemptHint: "When set to remote priority, MCP will prefer the remote GUI",
  remoteReclaimBtn: "Reclaim local",
  remoteReclaimOk: "Remote preemption cleared. MCP will prefer local GUI.",
  remoteLocalPinLabel: "Lock local GUI",
  remoteLocalPinHint: "When enabled, remote users cannot preempt MCP routing",
  remoteLocalPinOn: "Locked",
  remoteLocalPinOff: "Unlocked",
  remotePreemptPinnedErr: "Remote host is pinned by local user, cannot preempt.",
  remoteLoadingText: "Loading connections…",
  remoteLoadError: "Failed to load connections.",
  remoteRetryBtn: "Retry",
  remoteDetailPort: "Port",
  remoteDetailKey: "Key:",
